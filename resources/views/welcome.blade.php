        ...
        <div id="header-bar" class="container-fluid">
            <div class="menu">
                ...
                viewBox="0 0 88.1 88.2" enable-background="new 0 0 88.1 88.2" xml:space="preserve">
                    <g id="XMLID_15_">
                    <line id="XMLID_18_" fill="none" stroke="#13A8FD" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="76.1" y1="12.6" x2="44.1" y2="12.6"/>
                    ...
                    <line id="XMLID_16_" fill="none" stroke="#13A8FD" stroke-width="6" stroke-linecap="round" stroke-linejoin="round" stroke-miterlimit="10" x1="76.1" y1="75.6" x2="28.5" y2="75.6"/>
                    </g>
                </svg>
            </div>
            <div class="title-bar">
